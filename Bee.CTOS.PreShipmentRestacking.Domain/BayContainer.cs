...
namespace Bee.CTOS.PreShipmentRestacking.Domain
{
    ...
    internal class BayContainer
    {
        ...
        /// 翻入
        /// </summary>
        public MoveOperation MoveTo(int underRow, int fixingOrdinal, int currentRow, int targetRow, int limitRow, ref int[] fixedTiers, ref int[] topTiers, ref BayContainer?[,] bayMatrix, string remark)
        {
            ...
            //返回翻箱动作
            return new MoveOperation(_initialLocation.ContainerNo, readyRow, underRow, fixingOrdinal, isFixed, currentRow, targetRow, remark);
        }
